...
/*
Plugin Name: Mytory-Git-Embed
Description: Embed GitHub, Gist or Bitbucket files. wp-git-embed 플러그인을 가져와서 임의로 조금 수정한 코드. format에 md나 markdown이라고만 쓰면 markdown을 해석해서 보여 준다.
Version: 99.9
